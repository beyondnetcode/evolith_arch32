...
| [`GT-123`](./gap-reference-catalog.md#gt-123) | CLI does not build — pre-existing TypeScript errors block `tsc` (init.wizard, progress.service, alias, old MCP auto-fix) | `CLI` | Cross | P1 | L | `PENDING` |
...
**Progress:** 93 / 100 done · 0 in progress · 7 pending · 0 deferred
