...
Para contratos IN/OUT, comportamiento de resiliencia y guía de clientes por interfaz, consulta [Flujos de Interfaces del Core](../views/view-by-interface-flow.es.md).
