...
El Stack Audit ([ALERTA ROJA 2](../../../foundations/common-rules/detailed-stack-audit-2026.es.md)) marca esto como un elemento crítico, registrado bajo [GT-111](../../../control-center/gaps/gap-reference-catalog.es.md#gt-111).
...
- Seguimiento de gaps: [GT-111](../../../control-center/gaps/gap-reference-catalog.es.md#gt-111)
