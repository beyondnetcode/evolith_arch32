...
const TRACKING_EN = path.join(rootDir, 'reference/core/control-center/gaps/gap-tracking.md');
const TRACKING_ES = path.join(rootDir, 'reference/core/control-center/gaps/gap-tracking.es.md');
const CATALOG_EN = path.join(rootDir, 'reference/core/control-center/gaps/gap-reference-catalog.md');
const CATALOG_ES = path.join(rootDir, 'reference/core/control-center/gaps/gap-reference-catalog.es.md');
