...
violations[{"id": "MM-R01", "severity": "MUST", "title": "Single Deployment Unit", "blocking": true, "msg": msg}] {
...
violations[{"id": "MM-R02", "severity": "MUST", "title": "Explicit Bounded Context Boundaries", "blocking": true, "msg": msg}] {
	count(input.satellite.directories) < 2
	msg := "Found less than 2 modules in src/ (MM-R02)."
}

violations[{"id": "MM-R03", "severity": "MUST", "title": "Ports and Adapters Boundary", "blocking": true, "msg": msg}] {
...
violations[{"id": "MM-R04", "severity": "MUST", "title": "Inter-Context Communication via Ports", "blocking": true, "msg": msg}] {
	input.satellite.hasContracts == false
	msg := "No contracts/ directory found for inter-module contracts (MM-R04)."
}

violations[{"id": "MM-R05", "severity": "MUST", "title": "No Shared Database Across Bounded Contexts", "blocking": true, "msg": msg}] {
	input.satellite.hasAcl == false
	msg := "No acl/ directory found (should contain one subdirectory per bounded context) (MM-R05)."
}

violations[{"id": "MM-R06", "severity": "MUST", "title": "Async Events Use Domain Events", "blocking": false, "msg": msg}] {
	input.satellite.hasEvents == false
	msg := "No events directory found (MM-R06)."
}

violations[{"id": "MM-R07", "severity": "MUST", "title": "Maintain Extraction Readiness Score", "blocking": false, "msg": msg}] {
...
violations[{"id": "MM-R08", "severity": "MUST", "title": "Observability Instrumentation", "blocking": false, "msg": msg}] {
...
violations[{"id": "MM-R09", "severity": "MUST", "title": "Strict Dependency Inversion Principle (DIP)", "blocking": true, "msg": msg}] {
	some i
...
violations[{"id": "MM-R10", "severity": "MUST", "title": "AST-Based Code Analysis Mandatory", "blocking": true, "msg": msg}] {
	some i
	file := input.satellite.sourceFiles[i]
...
violations[{"id": "MM-R11", "severity": "MUST", "title": "Strict UI and Logic Isolation (SoC)", "blocking": true, "msg": msg}] {
	some i
	file := input.satellite.sourceFiles[i]
...
violations[{"id": "MM-R12", "severity": "SHOULD", "title": "Pure Domain Model (Data Mapper Enforcement)", "blocking": false, "msg": msg}] {
	some i
	file := input.satellite.sourceFiles[i]
