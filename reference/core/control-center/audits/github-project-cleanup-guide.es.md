# Guía de Limpieza de GitHub Project

**Fecha:** 2026-06-16  
**Propósito:** Eliminar items huérfanos y sincronizar GitHub Project with canonical backlog
...
#### Opportunities (10 items) - Todos DONE
| ID | Title | Estado |
|----|-------|--------|
...
#### Archivo (3 items) - Excluidos del Proyecto
| ID | Title | Razón |
|----|-------|--------|
...
## Items a ELIMINAR de GitHub Project

### Items Huérfanos (Ruido de Release Pipeline)

Fueron auto-creados por release-please during the sprint. NO son parte del backlog:

- DELETE Release Pipeline Failed (multiple instances, issues #21-#30)
  - **Acción:** Ya cerrados (9 issues)
  - **Estado:** DONE Limpiado

### Cualquier Item Sin Prefijo GAP- o OPP-
...
## Pasos de Limpieza Manual

### Step 1: Abrir GitHub Project
URL: https://github.com/users/beyondnetcode/projects/1/views/1

### Step 2: Filter by Estado
- Ver todos los items (not just "Backlog" or "DONE")

### Step 3: Identificar Huérfanos
Buscar items que:
- DELETE Don't have GAP-XXX or OPP-XXX in title
- DELETE Have empty description field
- DELETE Fueron creados en 2026-06-15/16 during release failures

### Step 4: Eliminar Huérfanos
For each orphan item:
1. Hacer clic en el item to open details
2. Click "..." menu
3. Seleccionar "Delete item"
4. Confirmar eliminación

### Step 5: Verificar Conteo Final
Después de limpieza, you should have exactly:
- **21 items** (11 GAPs + 10 OPPs) - all en estado DONE
- **0 items** en estado Backlog (all completed!)

---

## Verificación de Sincronización

Después de limpieza, run:
...
- [ ] Todos GAP-001 a GAP-011 existen and are DONE
- [ ] Todos OPP-001 a OPP-010 existen and are DONE
- [ ] Sin items con "Release Pipeline" in title
- [ ] Sin items sin GAP-/OPP- prefix
- [ ] Conteo total de items: 21 (not 25+)
- [ ] Script sync reporta "Todo está sincronizado"

---

## Notas

- **OPP-011, OPP-012, OPP-013** are intencionalmente excluidos (Archive status)
- Release-please PR #23 was merged (release 1.1.0)
- All 9 release pipeline issues (#21-#30) have been closed
- Stale PR #20 ha sido cerrado
