...
test_compliant_event_driven_has_no_violations if {
...
test_missing_asyncapi_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
...
test_missing_outbox_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
...
test_missing_dlq_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
...
test_missing_ordering_guarantee_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
...
test_missing_idempotency_key_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
...
test_missing_backward_compatible_schema_is_rejected if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
		"hasOrderingGuarantee": true, "hasIdempotencyKey": true,
...
test_missing_retention_policy_is_flagged if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
		"hasOrderingGuarantee": true, "hasIdempotencyKey": true,
...
test_missing_event_correlation_is_flagged if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
		"hasOrderingGuarantee": true, "hasIdempotencyKey": true,
		"hasBackwardCompatibleSchema": true, "hasRetentionPolicy": true,
...
test_missing_consumer_group_registry_is_flagged if {
	violations := eventdriven.violations with input as {"satellite": {"eventDriven": {
		"hasStrictAsyncApi": true, "hasOutbox": true, "hasDlq": true,
		"hasOrderingGuarantee": true, "hasIdempotencyKey": true,
		"hasBackwardCompatibleSchema": true, "hasRetentionPolicy": true,
