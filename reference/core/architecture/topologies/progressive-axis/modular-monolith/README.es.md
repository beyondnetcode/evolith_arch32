...
| [Reglas de Arquitectura F1](../../../../../../src/rulesets/topologies/progressive-axis/modular-monolith/modular-monolith.rules.json) | Reglas ejecutables existentes de compatibilidad. |
