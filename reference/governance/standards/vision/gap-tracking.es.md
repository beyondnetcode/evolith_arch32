...
|---|---|:---:|:---:|:---:|:---:|:---:|
| [`GT-152`](./gap-reference-catalog.es.md#gt-152) | Contrato de Conocimiento Externo y Esquema de Registro Fuente | `Governance` | Cross | P0 | S | `PENDIENTE` |
| [`GT-153`](./gap-reference-catalog.es.md#gt-153) | Gobierno del Ciclo de Vida del Conocimiento por Winston | `Governance` | Cross | P0 | M | `PENDIENTE` |
| [`GT-154`](./gap-reference-catalog.es.md#gt-154) | Proyección RAG y Paridad Native/OPA para Conocimiento Externo | `Governance` | Cross | P0 | M | `PENDIENTE` |
...
**Progreso:** 154 / 157 completados · 0 en progreso · 3 pendientes · 0 diferidos
