...
- **Local verification (2026-06-13):** `npm run test:cov --workspace @evolith/smart-cli -- --coverageReporters=json-summary` reports 80.65% statements and 81.47% lines from a clean unit run; lint and build are green. Status: `DONE`.
