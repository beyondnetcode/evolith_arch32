...
- **Provenance:** Encontrado el 2026-07-29 al verificar el CI del PR de `GT-634`, y al investigar se encontró en el árbol de trabajo un WIP sin commitear ya a medio camino hacia este mismo arreglo (confirmado con el usuario antes de continuarlo, según el propio registro de la sesión — ni descartado en silencio ni reclamado en silencio como trabajo preexistente propio).
- **Acceptance criteria:**
