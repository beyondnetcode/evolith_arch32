...
/ (raiz del repositorio)
 ...
 reference/                    # Corpus de referencia arquitectonica
   ...
   architecture/               # Autoridad arquitectonica y guia de implementacion
     ...
     blueprints-es/            # Baselines, topologia y perfiles de stack
     adrs-es/                  # Registros de decision y matriz de decisiones
     canonical-patterns-es/    # Patrones por runtime mapeados a ADRs
...
| Referencia canonica | Definir politica reutilizable, criterios de decision y trade-offs aceptados | `reference/architecture/blueprints-es/`, `reference/architecture/adrs-es/`, `reference/governance/` | Normativa o decisoria segun estado del documento |
| Guia de implementacion por runtime | Materializar decisiones aceptadas para un runtime declarado | `reference/architecture/canonical-patterns-es/`, blueprints y ADRs especificos | Reutilizable solo dentro del alcance declarado de runtime y ADR |
