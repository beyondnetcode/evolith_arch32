...
|---|---|:---:|:---:|:---:|:---:|:---:|:---:|
| [`GT-343`](./gap-reference-catalog.es.md#gt-343) | EPIC: unificar ids de fase SDLC (f1..f5) y vocabulario de topología F1/F2/F3 — etapa 1: módulo PhaseId canónico aterrizado | `Cross` | Cross | P0 | XL | `EN-PROGRESO` |
