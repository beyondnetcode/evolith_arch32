...
test_architect_can_deploy_in_production if {
...
test_empty_roles_is_rejected if {
...
test_unknown_tool_is_rejected if {
...
test_developer_can_write_in_non_production if {
...
test_operator_cannot_deploy_in_production if {
