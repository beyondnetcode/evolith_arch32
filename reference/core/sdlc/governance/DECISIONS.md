...
> Bilingual navigation: [Español](./DECISIONS.es.md)

This file is the entry point for upstream proposals from satellite repositories and key cross-cutting architectural decisions that complement the ADR record.

## Upstream Proposals

Proposals submitted by satellite repositories requesting Core to standardize, expose, or enforce a governance capability at the ecosystem level.
