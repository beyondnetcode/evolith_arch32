...
**Mayor problema ahora:** \`${biggest.component}\` concentra el mayor riesgo abierto ponderado (${biggest.open} pendientes, ${biggest.p0} P0). Ataca esa concentración junto con los P0 transversales antes de ampliar alcance de roadmap.
...
${renderBlockerTable(summary, true)}
...
**Biggest problem now:** \`${biggest.component}\` carries the highest weighted open risk (${biggest.open} open, ${biggest.p0} P0). Attack that concentration together with the cross-cutting P0 blockers before expanding roadmap scope.
