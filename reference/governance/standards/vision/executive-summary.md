...
**Biggest problem now:** `Agent Runtime` carries the highest weighted open risk (10 open, 0 P0). Attack that concentration before expanding scope.
...
| 2 | Highest-risk area | `Agent Runtime` has the largest weighted open load. | [GT-384](./gap-reference-catalog.md#gt-384), [GT-406](./gap-reference-catalog.md#gt-406), [GT-408](./gap-reference-catalog.md#gt-408), [GT-383](./gap-reference-catalog.md#gt-383), [GT-388](./gap-reference-catalog.md#gt-388), [GT-389](./gap-reference-catalog.md#gt-389), +4 |
| 3 | Quick wins | High criticality with XS/S complexity. | - |
| 4 | P1 wave | Next hardening after P0 is cleared. | [GT-324](./gap-reference-catalog.md#gt-324), [GT-384](./gap-reference-catalog.md#gt-384), [GT-406](./gap-reference-catalog.md#gt-406), [GT-408](./gap-reference-catalog.md#gt-408), [GT-383](./gap-reference-catalog.md#gt-383) |
...
|---|---:|---:|---:|---|
| `Agent Runtime` | 10 | 0 | 4 | [GT-384](./gap-reference-catalog.md#gt-384), [GT-406](./gap-reference-catalog.md#gt-406), [GT-408](./gap-reference-catalog.md#gt-408), [GT-383](./gap-reference-catalog.md#gt-383), +6 |
