...
|---|---|:---:|:---:|:---:|:---:|:---:|
| [`GT-152`](./gap-reference-catalog.es.md#gt-152) | Ingesta Multi-Arquitectura de Conocimiento Externo y Custodia de Winston | `Governance` | Cross | P0 | L | `PENDING` |
...
**Progreso:** 154 / 155 completados · 0 en progreso · 1 pendientes · 0 diferidos
