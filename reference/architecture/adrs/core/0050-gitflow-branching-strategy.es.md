...
Este ADR se alinea con [ADR-0005 CI/CD Quality CodeQL](./0005-ci-cd-quality-codeql.md), [ADR-0018 Testing Pyramid Quality Gates](./0018-testing-pyramid-quality-gates.md), y el ruleset ejecutable [`rulesets/adr/adr-0050-gitflow-branching.rules.json`](../../../../rulesets/adr/adr-0050-gitflow-branching.rules.json).
