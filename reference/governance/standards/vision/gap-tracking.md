...
| [`GT-148`](./gap-reference-catalog.md#gt-148) | Topology-Aware Rule Reference and Coverage Migration Repair | `Rulesets` | Cross | P1 | M | `PENDING` |
...
**Progress:** 147 / 153 done · 0 in progress · 6 pending · 0 deferred
