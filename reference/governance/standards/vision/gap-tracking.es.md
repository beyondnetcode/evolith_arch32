...
|---|---|:---:|:---:|:---:|:---:|:---:|
| [`GT-151`](./gap-reference-catalog.es.md#gt-151) | Completar la Cobertura de IDs de Regla Native/OPA para Topologías Aceptadas | `Rulesets` | Cross | P0 | M | `PENDING` |
...
**Progreso:** 153 / 154 completados · 0 en progreso · 1 pendientes · 0 diferidos
