# Índice de Estándares de Ingeniería

Utiliza este índice para estándares de ingeniería. Si buscas la ruta más rápida a Web, React, C#/.NET o estándares específicos de runtime, comienza con la página de acceso rápido primero.
...
* [contract-testing-guideline](./contract-testing-guideline.es.md)
* [detailed-stack-audit-2026](./detailed-stack-audit-2026.es.md)
* [engineering-manifesto](./engineering-manifesto.es.md)
* [gateway-guidelines](./gateway-guidelines.es.md)
* [observability-playbook](./observability-playbook.es.md)
* [senior-architectural-assessment](./senior-architectural-assessment.es.md)
* [vendor-risk-assessment](./vendor-risk-assessment.es.md)
