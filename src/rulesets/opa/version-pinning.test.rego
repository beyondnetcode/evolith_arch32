...
test_no_pinning_violations_for_exact_versions if {
...
test_caret_pinning_in_dependencies_is_rejected if {
	violations := version_pinning.violations with input as {"satellite": {"packageJson": {"dependencies": {"express": "^4.18.2"}, "devDependencies": {}}, "workspacePackageJsons": []}}
	violations[_].id == "DEP-01"
}

test_tilde_pinning_in_dev_dependencies_is_rejected if {
...
test_wildcard_pinning_is_rejected if {
...
test_workspace_caret_pinning_is_rejected if {
