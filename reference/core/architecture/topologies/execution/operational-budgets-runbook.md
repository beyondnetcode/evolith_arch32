...
- [`topology-manifest.schema.json`](../../../../../src/rulesets/schema/topology-manifest.schema.json) — schema definition of `operationalBudgets`.
...
- [GT-165](../../../control-center/gaps/gap-reference-catalog.md#gt-165) — Gap that established this runbook.
