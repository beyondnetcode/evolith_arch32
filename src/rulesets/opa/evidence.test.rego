...
test_complete_evidence_has_no_violations if {
...
test_missing_evidence_directory_is_rejected if {
	violations := evidence.violations with input as {"core": {"evidence": {}}}
	violations[_].id == "EVD-01"
}

test_evidence_missing_source_ref_is_rejected if {
...
test_evidence_missing_retention_period_is_rejected if {
