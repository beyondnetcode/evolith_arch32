...
- **Criterios de aceptación:**
  ...
  - [ ] Re-medido en un runner de CI y no en una laptop, contra el `k6-smoke.json` de una corrida Reliability posterior, para confirmar que la cola de 498 ms desapareció donde se observó. Las cifras locales subestiman este defecto unas 10× por construcción y no son la evidencia que lo cierra.
