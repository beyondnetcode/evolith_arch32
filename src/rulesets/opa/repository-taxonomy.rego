...
violations contains {"id": "TAX-01", "message": msg} if {
...
violations contains {"id": "TAX-02", "message": msg} if {
...
violations contains {"id": "TAX-03", "message": msg} if {
...
violations contains {"id": "TAX-04", "message": msg} if {
...
violations contains {"id": "TAX-09", "message": msg} if {
...
violations contains {"id": "TAX-10", "message": msg} if {
	file := input.repository.files[_]
...
violations contains {"id": "TAX-11", "message": "Root-level topologies/ directory is prohibited"} if {
