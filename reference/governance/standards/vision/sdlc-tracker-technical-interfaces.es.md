...
**Diseño Padre:** [Diseño Objetivo de Composición Gobernada](./evolith-governed-composition-target-design.es.md)  
...
- [Diseño Objetivo de Composición Gobernada](./evolith-governed-composition-target-design.es.md)
- [Modelo de Abstracción de Proveedores y Plugins](./evolith-provider-abstraction-plugin-model.es.md)
