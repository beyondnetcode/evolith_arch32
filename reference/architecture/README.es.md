...
| [Diseño de Arquitectura Evolith](./EVOLITH-ARCHITECTURE-DESIGN.md) | Diseño de sistema end-to-end consolidado y verificado (core-api, servidor MCP y Agent Runtime desplegados) | Ver la arquitectura tal como está construida y desplegada | Diseño de sistema | No |
