...
test_complete_gate_has_no_violations {
...
test_missing_mandatory_artifact_is_flagged {
  violations := phase_gates.violations with input as {
    "gate": {"phase": 2, "mandatoryEvidence": [{"artifact": "prd.md"}], "blockingCriteria": []},
    "evidence": [],
  }
...
test_active_blocking_criterion_is_flagged {
  violations := phase_gates.violations with input as {
...
test_waived_criterion_is_not_blocking {
  violations := phase_gates.violations with input as {
    "gate": {"phase": 2, "mandatoryEvidence": [], "blockingCriteria": [{"criterion": "security-review"}]},
    "evidence": [],
...
test_absent_gate_yields_no_violations {
  violations := phase_gates.violations with input as {}
  count(violations) == 0
}
