...
|---|---|:---:|:---:|:---:|:---:|
| [`GT-48`](./gap-reference-catalog.es.md#gt-48) | Restaurar el umbral normativo de cobertura del CLI | F0 | P0 | L | `PENDIENTE` |
| [`GT-47`](./gap-reference-catalog.es.md#gt-47) | Sincronización de documentación de producto y release | Transversal | P1 | S | `PENDIENTE` |
| [`GT-49`](./gap-reference-catalog.es.md#gt-49) | Activar el modo estricto de TypeScript y puertos de filesystem tipados | Transversal | P1 | M | `PENDIENTE` |
| [`GT-51`](./gap-reference-catalog.es.md#gt-51) | Validación de evidencia de gate Build-versus-Compose | F3 | P1 | M | `PENDIENTE` |
| [`GT-50`](./gap-reference-catalog.es.md#gt-50) | Aplicar umbrales de cobertura en la configuración de Jest | F0 | P2 | S | `PENDIENTE` |
| [`GT-52`](./gap-reference-catalog.es.md#gt-52) | Eliminar los stubs muertos del contenedor de inyección de dependencias | Transversal | P2 | S | `PENDIENTE` |
| [`GT-53`](./gap-reference-catalog.es.md#gt-53) | Reparar las referencias migradas a la visión de producto | Transversal | P2 | S | `PENDIENTE` |
| [`GT-54`](./gap-reference-catalog.es.md#gt-54) | Completar la aplicación estricta de fronteras hexagonales | Transversal | P2 | L | `PENDIENTE` |
...
**Progreso:** 38 / 46 completados · 0 en progreso · 8 pendientes · 0 diferidos
