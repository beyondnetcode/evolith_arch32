...
> **Ruta raíz de compatibilidad:** [DOCUMENTATION_VERSIONS.es.md](../../DOCUMENTATION_VERSIONS.es.md)
...
- [x] Todos los checks de CI pasan.
- [x] Paridad bilingüe verificada para todos los pares afectados.
...
Ver [ADR-0068](../architecture/adrs/core/0068-documentation-release-gitflow.es.md) para la política completa de GitFlow de lanzamiento de documentación.
