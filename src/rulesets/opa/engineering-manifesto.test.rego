...
test_compliant_code_has_no_violations if {
...
test_class_exceeding_200_lines_is_violation if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 250,
		"classMethodCount": 10,
		"liskovViolations": 0,
...
test_liskov_violations_detected if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 100,
		"classMethodCount": 8,
		"liskovViolations": 2,
...
test_domain_imports_infrastructure_is_violation if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 100,
		"classMethodCount": 8,
		"liskovViolations": 0,
...
test_cyclomatic_complexity_exceeds_threshold if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 100,
		"classMethodCount": 8,
		"liskovViolations": 0,
...
test_god_class_by_line_count if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 600,
		"classMethodCount": 10,
		"liskovViolations": 0,
...
test_god_class_by_method_count if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 300,
		"classMethodCount": 25,
		"liskovViolations": 0,
...
test_circular_dependencies_detected if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 100,
		"classMethodCount": 8,
		"liskovViolations": 0,
...
test_magic_numbers_detected if {
	violations := engineering_manifesto.violations with input as {
		"classLineCount": 100,
		"classMethodCount": 8,
		"liskovViolations": 0,
