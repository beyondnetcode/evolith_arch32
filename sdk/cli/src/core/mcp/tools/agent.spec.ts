import { handleAgentTools } from './agent';
...
describe('MCP Tools - agent', () => {
  ...
  describe('evolith-agent-install', () => {
    it('should install agent with standard template by default', async () => {
      const result = await handleAgentTools('evolith-agent-install', { name: 'test-agent', dir: '/test' });
  ...
  describe('evolith-agent-list', () => {
    it('should return empty list when no agents directory', async () => {
      ...
      const result = await handleAgentTools('evolith-agent-list', { dir: '/test' });
  ...
  describe('evolith-agent-validate', () => {
    it('should return invalid when agent not found', async () => {
      ...
      const result = await handleAgentTools('evolith-agent-validate', { name: 'test-agent', dir: '/test' });
    ...
    it('should detect missing agent name', async () => {
      ...
      expect((result as any).issues.some((i: any) => i.field === 'agent.name')).toBe(true);
    });
    ...
    it('should detect missing ruleset version', async () => {
      ...
      expect((result as any).issues.some((i: any) => i.field === 'ruleset.version')).toBe(true);
    });
    ...
    it('should detect missing principles', async () => {
      ...
      expect((result as any).issues.some((i: any) => i.field === 'principles')).toBe(true);
    });
  });
  ...
  describe('evolith-agent-upgrade', () => {
    it('should throw error when agent not found', async () => {
      ...
      await expect(handleAgentTools('evolith-agent-upgrade', { name: 'test-agent', dir: '/test' }))
    ...
    it('should increment patch version', async () => {
      ...
      const result = await handleAgentTools('evolith-agent-upgrade', { name: 'test-agent', dir: '/test' });
  ...
  describe('evolith-agent-remove', () => {
    it('should throw error when agent not found', async () => {
      ...
      await expect(handleAgentTools('evolith-agent-remove', { name: 'test-agent', dir: '/test' }))
        .rejects.toThrow('not found');
    });
    ...
    it('should remove agent directory', async () => {
      ...
      const result = await handleAgentTools('evolith-agent-remove', { name: 'test-agent', dir: '/test' });
  ...
  describe('unknown tool', () => {
    it('should throw error for unknown agent tool', async () => {
      await expect(handleAgentTools('evolith-agent-unknown', {}))
