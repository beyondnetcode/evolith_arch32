...
| [`GT-134`](./gap-reference-catalog.md#gt-134) | Standardized MCP Tools Registry | `Architecture` | Cross | P2 | M | `PENDING` |
...
**Progress:** 134 / 137 done · 0 in progress · 3 pending · 0 deferred
