...
|---|---|:---:|:---:|:---:|:---:|:---:|
| [`GT-110`](./gap-reference-catalog.md#gt-110) | Migrate ingress off the abandoned Kong OSS to Traefik/NGINX | `Platform` | Cross | P0 | L | `IN-PROGRESS` |
...
**Progress:** 70 / 108 done · 1 in progress · 36 pending · 1 deferred
