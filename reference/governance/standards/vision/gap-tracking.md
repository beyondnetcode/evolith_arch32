...
**Last Updated:** 2026-06-25 (Wilson production-readiness audit — 6 new gaps)
...
| [`GT-268`](./gap-reference-catalog.md#gt-268) | Restore missing CI validator scripts referenced by workflows and rules | `Governance CI` | Cross | P0 | S | `PENDING` |
...
| [`GT-269`](./gap-reference-catalog.md#gt-269) | Restore ADR-0073 contract roundtrip reproducibility | `Contracts` | Cross | P0 | M | `PENDING` |
| [`GT-233`](./gap-reference-catalog.md#gt-233) | Add rate limiting middleware to Core API | `Security` | Cross | P1 | S | `PENDING` |
...
**Progress:** 245 / 272 done · 0 in progress · 27 pending · 0 deferred
