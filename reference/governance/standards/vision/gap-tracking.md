...
|---|---|---|:---:|:---:|:---:|:---:|
| [`GT-152`](./gap-reference-catalog.md#gt-152) | Multi-Architecture External Knowledge Intake and Winston Stewardship | `Governance` | Cross | P0 | L | `PENDING` |
...
**Progress:** 154 / 155 done · 0 in progress · 1 pending · 0 deferred
