...
- **Provenance:** Found on 2026-07-29 while confirming PR #275's CI was green after the `GT-634` ratchet fix; fixed the same day across three follow-up requests from the user ("arréglalos los tres" for the first two, then "arregla el security audit también" after this closure's own first pass had deliberately left it open as too risky to force blind).
- **Acceptance criteria:**
