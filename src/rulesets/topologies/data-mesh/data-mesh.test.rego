...
test_compliant_data_mesh_has_no_violations if {
...
test_missing_data_product_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
...
test_missing_data_contracts_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
...
test_missing_federated_governance_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
...
test_missing_lineage_tracking_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
...
test_missing_retention_policy_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
...
test_missing_consumption_contracts_is_rejected if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
		"hasLineageTracking": true, "hasRetentionPolicy": true,
...
test_missing_data_quality_slo_is_flagged if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
		"hasLineageTracking": true, "hasRetentionPolicy": true,
...
test_missing_backward_compatible_contracts_is_flagged if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
		"hasLineageTracking": true, "hasRetentionPolicy": true,
		"hasConsumptionContracts": true, "hasDataQualitySLO": true,
...
test_missing_discovery_registration_is_flagged if {
	violations := datamesh.violations with input as {"satellite": {"dataMesh": {
		"isDataProduct": true, "hasDataContracts": true, "federatedGovernance": true,
		"hasLineageTracking": true, "hasRetentionPolicy": true,
		"hasConsumptionContracts": true, "hasDataQualitySLO": true,
