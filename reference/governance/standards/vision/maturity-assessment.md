...
All open gaps live exclusively on the **[Gap Tracking Board](./gap-tracking.md)** — current state: 19 pending, 1 deferred, 2 done out of 22 `GT` items, plus the closed legacy `G-01…G-27` archive. The maturity-relevant subset:

* **Tracker contract (P0):** [GT-02](./gap-tracking.md#gt-02), [GT-03](./gap-tracking.md#gt-03), [GT-06](./gap-tracking.md#gt-06) — contract ratified by [ADR 0073](../../../architecture/adrs/core/0073-unified-cli-output-contract.md)
