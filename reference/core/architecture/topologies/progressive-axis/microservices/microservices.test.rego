...
test_compliant_microservices_has_no_violations if {
...
test_missing_dockerfile_is_rejected if {
...
test_missing_bulkhead_is_rejected if {
...
test_missing_fallback_is_rejected if {
...
test_missing_contract_tests_is_rejected if {
...
test_missing_data_sovereignty_is_rejected if {
...
test_missing_slos_is_rejected if {
...
test_missing_oncall_is_rejected if {
