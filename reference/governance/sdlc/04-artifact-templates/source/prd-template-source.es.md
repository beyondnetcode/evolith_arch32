...
> Aprobado por: [Architecture Board / Sponsor — dejar en blanco hasta aprobación]
> Fecha: [AAAA-MM-DD]
...
[Describe el problema de negocio que este producto resuelve en 3–5 oraciones. Evita detalles tecnológicos. Enfócate en dolor, audiencia y costo de no resolverlo.]
...
| Tipo | Descripción |
|---|---|
| Regulatorio | [Restricciones de cumplimiento] |
| Técnico | [Restricciones de plataforma o stack aprobado] |
| Cronograma | [Fechas límite o ventanas de mercado] |
| Equipo | [Tamaño del equipo, brechas o dependencias externas] |
...
- Topología: [Monolito Modular según ADR-0047]
- Stack: [Alineado al Stack Tecnológico Autorizado]
- Multi-tenancy: [Sí/No — si sí, aplica ADR-0010]
- Preparación para extracción: [Fase objetivo si aplica]
