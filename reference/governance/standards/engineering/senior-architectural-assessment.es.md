...
- **Result<T,E> Pattern** ([ADR-0019](../../../architecture/adrs/core/0019-tactical-design-patterns-future-proofing.md)) sobre excepciones - decisión excelente para TypeScript, elimina side-effects implícitos.
...
| Stack .NET/C# | 4/10 | [ADR-0041](../../../architecture/adrs/dotnet/0041-canonical-dotnet-backend-architecture.md) existe pero está infradesarrollado vs Node.js |
...
**Hallazgo:** El [ADR-0006](../../../architecture/adrs/core/0006-future-microservices-transition-dapr.md) define 3 milestones (Monolith -> Service Extraction -> Full Mesh) pero no especifica los **triggers cuantitativos** que activan el paso entre fases.
...
**Referencia:** ADR a crear `[ADR-0045](../../../architecture/adrs/core/0045-microservice-extraction-readiness-criteria.md): Microservice Extraction Readiness Criteria`

---

### CRíTICO - C2: Estrategia de Base de Datos en Transición es Ambigua

**Hallazgo:** La arquitectura tiene `schema-per-context` ([ADR-0031](../../../architecture/adrs/core/0031-schema-per-context-domain-event-catalog.md)) pero no documenta cómo se gestiona la **transición desde una DB compartida a DBs aisladas por servicio** durante la fase de extracción.
...
Agregar a la documentación de `[ADR-0031](../../../architecture/adrs/core/0031-schema-per-context-domain-event-catalog.md)` una sección de Database Migration Path:
...
**Referencia:** Patrón "Database-per-Service" - Chris Richardson, microservices.io; [ADR-0033](../../../architecture/adrs/core/0033-transactional-outbox-pattern.md) (Transactional Outbox) ya existe pero no se encadena explícitamente con el plan.

---

### CRíTICO - C3: [ADR-0041](../../../architecture/adrs/dotnet/0041-canonical-dotnet-backend-architecture.md) (.NET) es un Ciudadano de Segunda Clase

**Hallazgo:** El stack Node.js tiene 14 ADRs dedicados. El stack .NET/C# tiene exactamente **1 ADR ([ADR-0041](../../../architecture/adrs/dotnet/0041-canonical-dotnet-backend-architecture.md))**. La tabla de runtimes del blueprint lo define como "High Compute / Workers / Batch" pero no hay:
...
```csharp
// [ADR-0041](../../../architecture/adrs/dotnet/0041-canonical-dotnet-backend-architecture.md) debería incluir estructura canónica:
/src
...
**Hallazgo:** El Engineering Manifesto y [ADR-0018](../../../architecture/adrs/core/0018-testing-pyramid-quality-gates.md) establecen `>70%` como umbral de cobertura.
...
**Hallazgo:** [ADR-0006](../../../architecture/adrs/core/0006-future-microservices-transition-dapr.md) propone Dapr Sidecars como mecanismo de transición a microservicios.
...
**Recomendación:** Documentar en [ADR-0006](../../../architecture/adrs/core/0006-future-microservices-transition-dapr.md) un **Decision Gate** explícito:
...
**Hallazgo:** [ADR-0035](../../../architecture/adrs/core/0035-distributed-saga-pattern-strategy.md) menciona "Compensating Transaction Strategy" pero el blueprint no incluye ningún ejemplo concreto de saga.
...
**Recomendación:** Agregar al [ADR-0035](../../../architecture/adrs/core/0035-distributed-saga-pattern-strategy.md) un ejemplo canónico en TypeScript:
...
**Recomendación:** Documentar en [ADR-0006](../../../architecture/adrs/core/0006-future-microservices-transition-dapr.md) cómo Kong (ya existente como Edge Gateway) puede implementar Strangler Fig:
...
**Hallazgo:** [ADR-0037](../../../architecture/adrs/core/0037-performance-concurrency-chaos-strategy.md) menciona K6 para load testing pero no incluye chaos engineering.
...
### [ADR-0041](../../../architecture/adrs/dotnet/0041-canonical-dotnet-backend-architecture.md) Gaps Concretos
...
El [ADR-0027](../../../architecture/adrs/nodejs/0027-dual-protocol-rest-grpc-api-gateway.md) define dual-protocol REST/gRPC pero no hay guía de implementación para el lado .NET. Recomendado:
...
| **R-05** | **TypeORM Deprecation Risk** - La implementación de referencia usa TypeORM mientras el stack auditado recomienda Drizzle | MEDIO | [ADR-0043](../../../architecture/adrs/nodejs/0043-data-access-orm-strategy.md) define la estrategia; asegurar migration path documentado |
...
| **R-08** | **Redis como SPOF** - Redis Cluster sin Sentinel o con configuración incorrecta puede causar data loss en failover | ALTO | Documentar configuración mínima de Redis Sentinel en [ADR-0014](../../../architecture/adrs/core/0014-distributed-caching-strategy-redis.md) |
...
### Sprint 1 (Inmediato)
- [x] [ADR-0045](../../../architecture/adrs/core/0045-microservice-extraction-readiness-criteria.md) ya existe — Microservice Extraction Readiness Criteria
- [] Enriquecer [ADR-0006](../../../architecture/adrs/core/0006-future-microservices-transition-dapr.md) con Decision Gate para Dapr
- [] Agregar Database Migration Path a [ADR-0031](../../../architecture/adrs/core/0031-schema-per-context-domain-event-catalog.md)
...
- [] Agregar ejemplo canónico de Saga a [ADR-0035](../../../architecture/adrs/core/0035-distributed-saga-pattern-strategy.md)
...
- [] Documentar Redis Sentinel config en [ADR-0014](../../../architecture/adrs/core/0014-distributed-caching-strategy-redis.md)
