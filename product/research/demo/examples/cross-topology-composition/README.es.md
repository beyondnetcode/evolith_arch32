...
> **Esquema:** [`topology-composition.schema.json`](../../../../../src/rulesets/schema/topology-composition.schema.json)
...
| `event-driven` está aceptado | Sí — manifiesto en `src/rulesets/topologies/event-driven/topology.manifest.json` |
...
| [Esquema de Manifiesto de Topología](../../../../../src/rulesets/schema/topology-manifest.schema.json) | Define `spec.compatibility.composableWith`. |
| [Esquema de Composición de Topologías](../../../../../src/rulesets/schema/topology-composition.schema.json) | Define la forma del manifiesto usado por este ejemplo. |
