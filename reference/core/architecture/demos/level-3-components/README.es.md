...
- **[Componentes del Agent Runtime](./agent-runtime-components.es.md):** Explorando la capa de orquestación (puertos y adaptadores), incluyendo la API de comandos/eventos, resolución de skills, aprobación, memoria, validación de políticas y publicación de trazas.
