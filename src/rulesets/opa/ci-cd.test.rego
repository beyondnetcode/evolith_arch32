...
test_ci_compliant_project_has_no_violations if {
...
test_missing_package_lock_is_rejected if {
...
test_missing_npm_ci_in_workflow_is_rejected if {
...
test_missing_dependabot_is_rejected if {
