...
Todos los gaps abiertos viven exclusivamente en el **[Tablero de Seguimiento de Gaps](./gap-tracking.es.md)** — estado actual: 20 pendientes, 1 diferido, 1 completado de 22 ítems `GT`, más el archivo legado cerrado `G-01…G-27`. El subconjunto relevante para madurez:

* **Contrato Tracker (P0):** [GT-01](./gap-tracking.es.md#gt-01), [GT-02](./gap-tracking.es.md#gt-02), [GT-03](./gap-tracking.es.md#gt-03), [GT-06](./gap-tracking.es.md#gt-06)
