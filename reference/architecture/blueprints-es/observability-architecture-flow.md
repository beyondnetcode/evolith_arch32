...
Complementa:
- [Observability Playbook](../../governance/standards-es/engineering/observability-playbook.md)
- [CP-01: Propagación de Contexto Scoped por Request](../canonical-patterns-es/dotnet/cp-01-request-scope-context-propagation.md)
- [CP-02: Logging PII-Safe con Serilog](../canonical-patterns-es/dotnet/cp-02-pii-safe-serilog-logging.md)
- [CP-04: Decorador AOP de Logging](../canonical-patterns-es/dotnet/cp-04-aop-logging-decorator.md)
- [ADR-0064: .NET Request-Scope Observability Context](../adrs-es/dotnet/0064-dotnet-request-scope-observability-context.md)
...
Ambos son compatibles con Evolith. El primero es más simple para entornos locales y containerizados. El segundo puede reducir moving parts cuando el runtime y la estrategia de sinks lo justifican.

## 7. Decisión de Promoción

Este blueprint sí pertenece a Evolith porque no es específico de un producto. Generaliza las mismas necesidades para cualquier servicio `.NET + Serilog + OpenTelemetry + AOP` alineado con la plataforma.
