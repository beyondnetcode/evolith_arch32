...
{
  "data": {
    "blockingNonExecutableRuleIds": "<blockingNonExecutableRuleIds[]>",
    "blockingSkippedRuleIds": "<blockingSkippedRuleIds[]>",
    "coreRef": {
      "path": "/abs/path/to/evolith-core",
      "version": null
    },
    "corpusTotal": "<n>",
    "erroredRuleIds": "<erroredRuleIds[]>",
    "issues": "<issues[]>",
    "nonExecutableRuleIds": "<nonExecutableRuleIds[]>",
    "notApplicableRuleIds": "<notApplicableRuleIds[]>",
    "perRuleset": "<perRuleset[]>",
    "rulesChecked": "<n>",
    "rulesErrored": "<n>",
    "rulesExecutable": "<n>",
    "rulesNonExecutable": "<n>",
    "rulesNotApplicable": "<n>",
    "rulesSkipped": "<n>",
    "rulesTotal": "<n>",
