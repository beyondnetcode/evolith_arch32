...
|---|---|---|:---:|:---:|:---:|:---:|
| [`GT-135`](./gap-reference-catalog.md#gt-135) | Agentic AI Telemetry & Cost Control Standard | `Architecture` | Cross | P1 | M | `PENDING` |
...
**Progress:** 137 / 142 done · 0 in progress · 5 pending · 0 deferred
