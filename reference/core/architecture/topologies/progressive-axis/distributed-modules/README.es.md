...
| [Reglas de Arquitectura F2](../../../../../../src/rulesets/topologies/progressive-axis/distributed-modules/distributed-modules.rules.json) | Reglas ejecutables existentes de compatibilidad. |
