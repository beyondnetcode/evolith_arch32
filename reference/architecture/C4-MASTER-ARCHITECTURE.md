...
| **Level 2** | Containers | The implemented logical runtimes: Core API, MCP Server, Agent Runtime API/Engine, Smart CLI, Redis cache, and reference corpus. Tracker remains external to this repository. | [Level 2: Containers](./c4-levels/level-2-containers.md) |
| **Level 3** | Components | The internal building blocks of each container: controllers, commands, tool registries, use cases, adapters, evaluators, and domain services. | [Level 3: Components](./c4-levels/level-3-components/README.md) |
...
- **Visual Map (Interactive Explorer):** Visual and dynamic navigation of the C4 model, flows, and integrations. [Open Visual Map](./visual-map/index.html)
