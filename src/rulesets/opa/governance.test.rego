...
test_satellite_without_rulesets_has_no_violations if {
...
test_satellite_with_rulesets_is_rejected if {
...
test_satellite_missing_decisions_md_is_rejected if {
...
test_core_repo_is_exempt_from_inheritance_rules if {
