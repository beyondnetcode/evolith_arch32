...
| **MoSCoW Prioritization Matrix** | [moSCoW template](./04-artifact-templates/ballpark-estimation-template.md) | MoSCoW analysis with at least one MUST item. |
| **Build-versus-Compose Analysis** | [build-vs-compose.schema.json](../../../src/rulesets/schema/build-vs-compose.schema.json) | Adopt/Embed/Integrate/Extend/Build/Reject disposition per Product Vision §5.3. |
...
|---|---|---|
| Evolutionary Strategy Roadmap | [evolutionary-strategy-roadmap.md](../../../product/suite/strategy/evolutionary-strategy-roadmap.md) | When the product roadmap spans multiple Evolith phases. |
| Maturity Assessment | [maturity-assessment.md](../control-center/maturity-reports/maturity-assessment.md) | When assessing a brownfield product or formal maturity position. |
| Architecture Communication Strategy | [architecture-communication-strategy.md](../foundations/common-rules/communication/architecture-communication-strategy.md) | When preparing stakeholder or executive architecture briefings. |
| UMS Reference Model | [ums-reference-model.md](../../../product/research/demo/ums-reference-model.md) | When the product operates in identity, access management, or multi-tenant authorization. |
...
| **Functional Stories** | [functional-story-template.md](./04-artifact-templates/functional-story-template.md) | BDD-ready stories in Ready state, traceable to PRD. Use Functional Story Template as authoring format and Functional Story Writing Standard as quality guide. |
...
| Canonical Patterns | [canonical-patterns](../architecture/patterns/README.md) | When adopting runtime-specific reference implementations. |
| UMS Technical Overview | [ums-technical-overview.md](../../../product/research/demo/ums-technical-overview.md) | When identity or authorization patterns from UMS are directly applicable. |
...
| 5 | Write Functional Stories from the approved scope | Functional Stories |
...
| **Engineering Manifesto** | [engineering-manifesto.md](../foundations/common-rules/engineering-manifesto.md) | Governs SOLID, DRY, KISS, YAGNI, anti-patterns, and PR discipline. |
...
| **Canonical Patterns** | [canonical-patterns](../architecture/patterns/README.md) | Runtime-specific implementations must follow governed ADR patterns. |

### Optional or Conditional Artifacts

| Artifact | Location | When to Use |
|---|---|---|
| Contract Testing Guideline | [contract-testing-guideline.md](../foundations/common-rules/contract-testing-guideline.md) | Conditional: when the product exposes or consumes inter-service contracts. |
| Vendor Risk Assessment | [vendor-risk-assessment.md](../foundations/common-rules/vendor-risk-assessment.md) | When introducing a new third-party library or service. |
...
| AI Architecture Assistant | [AI Architecture Assistant](../foundations/common-rules/ai-augmented/08-architecture-ai-assistant/README.md) | When the team operates under an AI-augmented engineering workflow. |
| UMS Reference Model | [ums-reference-model.md](../../../product/research/demo/ums-reference-model.md) | Concrete implementation reference for .NET, hexagonal boundaries, bounded contexts, and RLS. |
...
| **Contract Testing Guideline** | [contract-testing-guideline.md](../foundations/common-rules/contract-testing-guideline.md) | Conditional: required when the product exposes inter-service contracts. |
...
| Vendor Risk Assessment | [vendor-risk-assessment.md](../foundations/common-rules/vendor-risk-assessment.md) | When validation includes a third-party dependency audit. |
...
| **Operations Hub** | [Operations Hub](../../../product/operations/README.md) | Observability deployment specification and runbooks. |
| **Infrastructure Hub** | [Infrastructure Hub](../../../product/infra/README.md) | Infrastructure provisioning specifications. |
...
| 3 | **Engineering Manifesto** | [engineering-manifesto.md](../foundations/common-rules/engineering-manifesto.md) | Sets engineering principles that govern code and team behavior. |
...
| 5 | **Repository Taxonomy** | [repository-taxonomy.md](../control-center/taxonomy/repository-taxonomy.md) | Naming, structure, and taxonomy rules apply from repository creation. |
...
| Getting Started by Role | Role-specific reading paths that align with lifecycle phases. |
