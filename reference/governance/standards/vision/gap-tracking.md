...
|---|---|:---:|:---:|:---:|:---:|
| [`GT-28`](./gap-reference-catalog.md#gt-28) | Restore CLI build, test, and smoke baseline | F0 | P0 | M | `PENDING` |
...
| [`GT-45`](./gap-reference-catalog.md#gt-45) | MCP transport and tool conformance suite | F2 | P1 | M | `PENDING` |
| [`GT-46`](./gap-reference-catalog.md#gt-46) | Core HTTP service ownership boundary | F2 | P1 | M | `PENDING` |
...
**Progress:** 33 / 39 done · 0 in progress · 6 pending · 0 deferred
