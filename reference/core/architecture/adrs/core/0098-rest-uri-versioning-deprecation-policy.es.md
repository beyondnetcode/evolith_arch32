...
- [GT-155](../../../control-center/gaps/gap-reference-catalog.es.md#gt-155) — Precondición de conformidad del envelope.
- [GT-159](../../../control-center/gaps/gap-reference-catalog.es.md#gt-159) — Esta decisión realiza el gap.
- [GT-174](../../../control-center/gaps/gap-reference-catalog.es.md#gt-174) — `meta.schemaVersion` y matriz de compatibilidad entre superficies (downstream).
