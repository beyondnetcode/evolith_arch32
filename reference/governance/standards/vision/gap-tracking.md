...
|---|---|:---:|:---:|:---:|:---:|
| [`GT-28`](./gap-reference-catalog.md#gt-28) | Restore CLI build, test, and smoke baseline | F0 | P0 | M | `IN-PROGRESS` |
| [`GT-29`](./gap-reference-catalog.md#gt-29) | Native/OPA rule execution parity | F1 | P0 | L | `IN-PROGRESS` |
...
| [`GT-09`](./gap-reference-catalog.md#gt-09) | Phase 3 real coverage enforcement | F3 | P1 | S | `IN-PROGRESS` |
| [`GT-12`](./gap-reference-catalog.md#gt-12) | `--dry-run` on all write operations | F3 | P1 | S | `IN-PROGRESS` |
| [`GT-14`](./gap-reference-catalog.md#gt-14) | Outbound webhook on gate completion | F4 | P1 | S | `IN-PROGRESS` |
| [`GT-05`](./gap-reference-catalog.md#gt-05) | MCP SDK Streamable HTTP transport | F2 | P1 | M | `IN-PROGRESS` |
| [`GT-10`](./gap-reference-catalog.md#gt-10) | Phase 4 security scan content validation | F3 | P1 | M | `IN-PROGRESS` |
| [`GT-11`](./gap-reference-catalog.md#gt-11) | Phase 5 observability and rollback validation | F3 | P1 | M | `IN-PROGRESS` |
...
| [`GT-03`](./gap-reference-catalog.md#gt-03) | `EvaluateGateUseCase` and `gate evaluate` command | F1 | P0 | M | `DONE` |
