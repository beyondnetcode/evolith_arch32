...
| [`GT-159`](./gap-reference-catalog.es.md#gt-159) | Versionado de URI y política de deprecación de la API REST | `BFF API` | Cross | P1 | S | `PENDIENTE` |
...
**Progreso:** 157 / 177 completados · 1 en progreso · 19 pendientes · 0 diferidos
