...
All notable changes to the Evolith Core API will be documented in this file. This project adheres to Semantic Versioning and matches the deprecation/sunset timelines defined by [ADR-0098](../../architecture/adrs/core/0098-rest-uri-versioning-deprecation-policy.md).
...
### Features
- **Envelope Conformance (GT-155):** Brought all REST controllers into conformance with the unified `{success, data, meta}` output envelope defined in [ADR-0073](../../architecture/adrs/core/0073-unified-cli-output-contract.md).
