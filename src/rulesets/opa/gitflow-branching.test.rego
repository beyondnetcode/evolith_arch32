...
test_compliant_gitflow_has_no_violations if {
	violations := gitflow_branching.violations with input as compliant_input
	count(violations) == 0
}

test_invalid_branch_name_is_rejected if {
