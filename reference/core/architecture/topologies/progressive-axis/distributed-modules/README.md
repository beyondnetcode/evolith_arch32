...
| [F2 Architecture Rules](../../../../../../src/rulesets/topologies/progressive-axis/distributed-modules/distributed-modules.rules.json) | Existing executable compatibility rules. |
