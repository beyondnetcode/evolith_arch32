...
| **Infraestructura (Transitorio)** | Inesperado | **Reintento con Backoff** ([ADR-0011](../core/0011-fault-tolerance-resiliency-patterns.es.md)). Si es permanente, lanzar excepción genérica. | 500, 503 |
...
Backfill histórico: Abordar la tensión arquitectónica donde los bloques JavaScript estándar `try/catch` hacen que los flujos de error sean invisibles para el Sistema de Tipos, estableciendo un límite estándar.

## Opciones Consideradas

- **Seleccionada:** Estrategia Empresarial de Manejo de Errores y Patrón Result
