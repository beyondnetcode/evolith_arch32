...
| [`GT-345`](./gap-reference-catalog.md#gt-345) | Smart CLI unit 905/905 + e2e 19/20 green (+restored validate command, +--version); only mcp-e2e (MCP HTTP) remains | `Smart CLI` | Cross | P1 | L | `IN-PROGRESS` |
...
**Progress:** 329 / 358 done · 17 in progress · 11 pending · 1 deferred
