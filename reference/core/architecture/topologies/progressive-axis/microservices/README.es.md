...
| [Reglas de Arquitectura F3](../../../../../../src/rulesets/topologies/progressive-axis/microservices/microservices.rules.json) | Reglas ejecutables existentes de compatibilidad. |
