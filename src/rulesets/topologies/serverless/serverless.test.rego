...
test_compliant_serverless_has_no_violations if {
...
test_missing_contract_is_rejected if {
...
test_non_stateless_is_rejected if {
...
test_missing_package_bound_is_rejected if {
...
test_missing_cold_start_readiness_is_rejected if {
