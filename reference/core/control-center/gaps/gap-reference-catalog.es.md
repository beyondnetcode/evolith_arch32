...
- **Acceptance criteria:**
  ...
  - [ ] Observado en verde en un runner, dentro de `Governance guards (GT-578)`, con el bundle compilado por el paso previo y `--require-wasm` haciendo fatal un bundle que no se pudo construir.
