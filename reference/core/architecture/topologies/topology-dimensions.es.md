...
> **Referencia ejecutable:** [`examples/cross-topology-composition/`](../../../../product/research/demo/examples/cross-topology-composition/README.es.md) publica una composición ejecutable `modular-monolith + event-driven`. El script CI `.harness/scripts/ci/22-validate-topology-composition.mjs` la valida en cada commit contra [`topology-composition.schema.json`](../../../../src/rulesets/schema/topology-composition.schema.json).
