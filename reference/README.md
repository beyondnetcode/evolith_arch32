...
| [architecture/](./architecture/README.md) | Blueprints, ADRs, topology, stack profiles, and canonical patterns |
...
| [knowledge/](./knowledge/demo/README.md) | UMS applied reference, migration history, research, examples, and learning material |
