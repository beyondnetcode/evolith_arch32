...
test_compliant_baseline_has_no_violations if {
...
test_missing_pillar_is_violation if {
	violations := compliance_baseline.violations with input as {"context": {"spec": {"compliance": {
		"agnosticBaseline": "reference/agnostic-baseline.md",
		"referenceBlueprint": "reference/blueprint.md",
		"engineeringManifesto": "reference/engineering-manifesto.md",
		"definitionOfDone": "reference/dod.md",
...
test_empty_pillar_reference_is_violation if {
	violations := compliance_baseline.violations with input as {"context": {"spec": {"compliance": {
		"agnosticBaseline": "reference/agnostic-baseline.md",
		"referenceBlueprint": "",
		"engineeringManifesto": "reference/engineering-manifesto.md",
...
test_non_string_pillar_reference_is_violation if {
	violations := compliance_baseline.violations with input as {"context": {"spec": {"compliance": {
		"agnosticBaseline": "reference/agnostic-baseline.md",
...
test_multiple_missing_pillars if {
	violations := compliance_baseline.violations with input as {"context": {"spec": {"compliance": {"agnosticBaseline": "ref.md"}}}}
	count(violations) >= 1
	violations[_].id == "CB-VAL-01"
}

test_all_empty_references if {
	violations := compliance_baseline.violations with input as {
		"context": {"spec": {"compliance": {
			"agnosticBaseline": "",
			"referenceBlueprint": "",
...
test_absent_spec_yields_no_violations if {
	violations := compliance_baseline.violations with input as {}
	count(violations) == 0
}

test_context_without_spec_yields_no_violations if {
