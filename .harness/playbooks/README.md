...
Reusable workflows for agents and contributors working under BMAD-METHOD governance.
...
Before executing repeated audit, design, or review tasks, load the most relevant playbook together with:

- `AGENTS.md`
- `.harness/rules/global-rules.md`
- the authoritative runtime profile or ADRs for the target change
