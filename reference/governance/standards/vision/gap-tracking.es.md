...
| [`GT-111`](./gap-reference-catalog.es.md#gt-111) | Planificar el giro comercial de MassTransit v9 (quedarse en v8 OSS o migrar a Rebus) | `Platform` | Transversal | P1 | L | `REVISIÓN` |
...
**Progreso:** 75 / 108 completados · 0 en progreso · 31 pendientes · 1 diferidos · 1 revisión
