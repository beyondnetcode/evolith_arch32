...
function render(inv, es) {
  const t = es
    ? { title: 'Inventario de Superficie del Producto', intro: 'Inventario generado de la superficie instalable de Smart CLI y MCP. No editar a mano.', field: 'Campo', value: 'Valor', cov: 'Cobertura de statements', covPending: 'pendiente de un run de cobertura' }
    : { title: 'Product Surface Inventory', intro: 'Generated inventory of the installable Smart CLI and MCP surface. Do not edit by hand.', field: 'Field', value: 'Value', cov: 'Statement coverage', covPending: 'pending a coverage run' };
