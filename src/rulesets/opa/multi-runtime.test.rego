...
test_compliant_multi_runtime_has_no_violations if {
	violations := multi_runtime.violations with input as compliant_input
	count(violations) == 0
}

test_runtime_selection_not_documented_is_rejected if {
