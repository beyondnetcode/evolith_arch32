# Evolith Product Suite — Strategy

> **Bilingual navigation:** [Versión en Español](./README.es.md)

**Classification:** Product Suite Strategy

This area contains portfolio strategy, business model, Open-Core direction, composability strategy, adoption plans, and cross-product validation methods.

> **Goal:** sequence the portfolio bets and the business model that funds them.
>
> **Objectives:** keep strategy, adoption plans, and validation methods consistent with the Suite vision and reviewable as one corpus.
