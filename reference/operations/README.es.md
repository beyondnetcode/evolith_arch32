...
Este directorio contiene la configuración operativa y el stack de observabilidad para la referencia de arquitectura progresiva. Todos los componentes son OSS, auto-hospedados y agnósticos al proveedor según el [ADR-0028](../architecture/adrs-es/core/0028-self-hosted-hybrid-infrastructure-on-premise.md).
...
La estrategia de instrumentación completa está definida en el [ADR-0007](../architecture/adrs-es/nodejs/0007-observability-telemetry-loki-opentelemetry.md).
