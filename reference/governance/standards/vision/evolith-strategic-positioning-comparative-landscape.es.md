...
- **Gobernanza relacionada:** [Directivas Arquitectónicas](./architectural-directives.es.md)
- **Plan de evolución:** [Roadmap de Estrategia Evolutiva](./evolutionary-strategy-roadmap.es.md)
- **Madurez operacional:** [Evaluación de Madurez](./maturity-assessment.es.md)
