...
| Chart | Description |
| :--- | :--- |
| `evolith-core-api/` | Helm chart for the CORE-API (ADR-0074); `evolith.beyondnet.cloud`, API-key secret, in-process OPA (no sidecar) |
| `evolith-mcp/` | Helm chart for the MCP server; `mcpevolith.beyondnet.cloud`, OPA sidecar |
